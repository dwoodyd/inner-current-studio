...
const items = [
  { icon: BookOpen, title: 'Future Pages', description: 'Guided reflective writing from a resonant self.', to: '/reflect/future-pages' },
  { icon: Lightbulb, title: 'Imagine If', description: 'Open possibility rituals that feel playful and real.', to: '/reflect/imagine-if' },
  { icon: Droplets, title: 'Overflow Practice', description: 'An original receiving and sufficiency ritual.', to: '/reflect/overflow' },
  { icon: Archive, title: 'My Current', description: 'Your private archive of inner work.', to: '/reflect/archive' },
];
  ...
  return (
    <div className="mx-auto max-w-lg px-4 pt-12 pb-6 space-y-6">
      ...
      <div className="space-y-3">
        {items.map(({ icon: Icon, title, description, to }, i) => (
          <motion.button
            key={title}
